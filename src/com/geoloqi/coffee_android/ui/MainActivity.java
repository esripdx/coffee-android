...
public class MainActivity extends Activity {
  ...
  public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
    if (parent != null) {
      // Set up some references ahead of time
      mParent = parent;
      mNoConnectionTextView = (TextView) parent.findViewById(R.id.textview_no_connection);
  ...
  private void loadWebView() {
    if (!JsonHttpClient.isConnected(this)) {
      ...
      if (mWebView != null) {
        ...
        mWebView.loadUrl(TEST_URL, headers);
      } else {
